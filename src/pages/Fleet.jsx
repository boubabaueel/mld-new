    ...
    const fleetData = [
      {
        ...
        capacity: 3,
        luggage: 2,
        features: ['Leather Interior', 'Bottled Water', 'Premium Sound System'],
      ...
      },
      {
        ...
        image: <img alt="Elegant black Cadillac Escalade luxury SUV" className="w-full h-64 object-cover rounded-t-lg" src="/u6291929893_create_an_image_of_a_2025_cadillac_escalade_and_a_afc065c3-4884-4f6f-bc75-6ec7962b949c_3 copy copy.png" />
      },
      {
